...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeerUser", b =>
                {
                    b.Property<string>("FavoriteBeersId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("FavoriteUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("FavoriteBeersId", "FavoriteUsersId");
            ...
            modelBuilder.Entity("BloodTypeC.DAL.Models.AdminReportsOptions", b =>
                {
                    ...
                    b.Property<string>("SendTargetEmail")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("AdminReportsOptions");
                });
            ...
            modelBuilder.Entity("BloodTypeC.DAL.Models.UserActivity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BeerUser", b =>
                {
                    ...
                    b.HasOne("BloodTypeC.DAL.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BloodTypeC.DAL.Models.Beer", b =>
                {
                    b.HasOne("BloodTypeC.DAL.Models.User", "AddedByUser")
                        .WithMany("AddedBeers")
            ...
            modelBuilder.Entity("BloodTypeC.DAL.Models.UserActivity", b =>
                {
                    b.HasOne("BloodTypeC.DAL.Models.User", "User")
